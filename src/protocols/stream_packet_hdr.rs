...
pub struct StreamPacketHeaderBuilder {
    pub wnd: u16,
    pub nack: u32,
}

impl StreamPacketHeaderBuilder {
    pub fn build(self) -> Result<StreamPacketHeader, Error> {
        let this = StreamPacketHeader {
            wnd: self.wnd,
            nack: self.nack,
        };
        this.check_rep();
...
mod tests {
    ...
    fn test_1() {
        ...
        let hdr2 = StreamPacketHeader::from_bytes(&mut rdr).unwrap();
